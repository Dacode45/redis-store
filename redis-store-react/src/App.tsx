...
firebase.initializeApp({
  ...
  authDomain: "redis-chat-hackathon-app.firebaseapp.com",
  projectId: "redis-chat-hackathon-app",
  storageBucket: "redis-chat-hackathon-app.appspot.com",
  messagingSenderId: "236019956579",
...
function ChatRoom() {
  ...
  const sendMessage = async (e) => {
    ...
    setFormValue('');
    (dummy.current as any).scrollIntoView({ behavior: 'smooth' });
  }
